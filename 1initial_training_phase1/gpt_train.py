...
from utilities.model import GPT, Block, Config
from utilities.packed_dataset import CombinedDataset, PackedDataset,LLMGeneratedDataset
from utilities.speed_monitor import SpeedMonitorBase, estimate_flops, measure_flops
from utilities.speed_monitor import SpeedMonitorFabric as SpeedMonitor
from utilities.utils import chunked_cross_entropy, get_default_supported_precision, num_parameters, load_checkpoint
from utilities.prepared_data import *
#from utilities.packed_dataset import LLMGeneratedDataset
...
if len(os.listdir('data/data_gneration/'))>0:
    for i in os.listdir('data/data_gneration/'):
        os.system(f'rm data/data_gneration/{i}')
files_del=os.listdir('data/redpajama_sample')
for i in files_del:
    if 'generated_data' in i:
        os.system(f'rm data/redpajama_sample/{i}')
...
data_config = [
    ...
    ("c4_sample_00000000", 29.0), 
    ("generated_data_00000000", 5.0)
]
